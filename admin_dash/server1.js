...
const connection = mysql.createConnection({
  ...
  password: '25102004', // Change this to your MySQL password
  database: 'dbms_project' // Change this to your database name
});
...
// Function to insert teacher data
...
app.post('/reset', (req, res) => {
  ...
  connection.query(resetQueries.join(';'), (err) => {
    if (err) {
